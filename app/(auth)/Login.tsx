    ...
    return (
        <SafeAreaView className="flex-1 bg-black">
            <View className="px-6 pt-10 pb-6">
                <Text className="uppercase tracking-widest text-primary text-3xl font-bold drop-shadow mb-2">Rutafit</Text>
            ...
            <View className="px-6">
                ...
                <View className="mb-4">
                    ...
                    {!!emailHint && (
                        <Text className="text-xs mt-1 text-primary">{emailHint}</Text>
                    )}
                </View>
                ...
                <View className="mb-2">
                    ...
                    {!!pwHint && (
                        <Text className="text-xs mt-1 text-primary">{pwHint}</Text>
                    )}
                </View>
